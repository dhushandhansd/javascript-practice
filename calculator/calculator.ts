function __calculate() {
  var calcArr = (<HTMLInputElement>document.getElementById('calc-input')).value.split(" ")
  ...
  console.log(output)
  var inputField = (<HTMLInputElement>document.getElementById('calc-input'))
...
function __numberFunction(number) {
  var fieldInput = (<HTMLInputElement>document.getElementById('calc-ipnut'))
